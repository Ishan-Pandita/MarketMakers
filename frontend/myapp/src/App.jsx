// src/App.jsx — MarketMakers Light Theme
...
function App() {
  return (
    <ErrorBoundary>
      <AuthProvider>
        <div className="min-h-screen bg-surface text-slate-heading font-body selection:bg-indigo-100 selection:text-indigo-700 relative">
                ...
                <Route path="*" element={
                  <div className="min-h-[80vh] flex items-center justify-center p-6 text-center">
                    <div className="max-w-md animate-fadeIn">
                      <div className="text-9xl font-extrabold text-slate-border mb-[-1rem] select-none tracking-tighter">404</div>
                      <h1 className="text-3xl font-extrabold text-slate-heading mb-4 tracking-tight">Page Not Found</h1>
                      <p className="text-slate-body mb-8 leading-relaxed">The page you're looking for doesn't exist or has been moved.</p>
